...
public class FastApiHalfwaySemanticChecker<A extends AbstractState<A>> implements SemanticCheck<A> {
    ...
    @Override
    public void afterExecution(CheckToolWithAnalysisResults<A> tooll) { }
    ...
    @Override
    public void visitGlobal(CheckToolWithAnalysisResults<A> tool, Unit unit, Global global, boolean instance) { }
