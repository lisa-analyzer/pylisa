...
/**
 * A Python less function call (e1 < e2).
 * 
 * @author Nicolò Barbato
 */

public class PyLess extends BinaryNativeCall {

	/**
	 * Builds a Python less expression at a given location in the program.
	 * 
	...
	public PyLess(CFG cfg, CodeLocation loc, Expression left, Expression right) {
