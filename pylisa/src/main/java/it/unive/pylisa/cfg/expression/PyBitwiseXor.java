...
/**
 * Python's bitwise xor ({@code a ^ b}). It evaluates {@code a} and
 * {@code b}, then dispatches to {@code type(a).__xor__(a, b)}, falling back
 * to {@code type(b).__rxor__(b, a)} if needed (this codebase has no notion
