...
/**
 * A Python not function call (e1 <> e2).
 * 
 * @author Nicolò Barbato
 */

public class PyNot1 extends BinaryNativeCall {
	...
	public PyNot1(CFG cfg, String sourceFile, int line, int col, Expression left, Expression right) {
