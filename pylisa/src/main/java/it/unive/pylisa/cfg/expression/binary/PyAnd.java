...
/**
 * A Python and function call (e1 & e2).
 * 
 * @author Nicolò Barbato
 */

public class PyAnd extends BinaryNativeCall {

	
	/**
	 * Builds a Python and expression at a given location in the program.
	 * 
	...
	public PyAnd(CFG cfg, CodeLocation loc, Expression left, Expression right) {
			super(cfg, loc, "and", PyBoolType.INSTANCE, left, right);
	}
