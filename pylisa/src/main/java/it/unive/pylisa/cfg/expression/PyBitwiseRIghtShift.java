...
/**
 * Python's right shift ({@code a >> b}). It evaluates {@code a} and
 * {@code b}, then dispatches to {@code type(a).__rshift__(a, b)}, falling
 * back to {@code type(b).__rrshift__(b, a)} if needed. If neither supports
