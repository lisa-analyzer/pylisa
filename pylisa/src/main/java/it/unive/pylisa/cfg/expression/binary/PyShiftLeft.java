...
/**
 * A Python zero fill left shift function call (e1 << e2).
 * 
 * @author Nicolò Barbato
 */

public class PyShiftLeft  extends BinaryNativeCall{

	/**
	 * Builds a Python zero fill left shift  expression at a given location in the program.
	 * 
	...
	public PyShiftLeft(CFG cfg, String sourceFile, int line, int col, Expression left, Expression right) {
