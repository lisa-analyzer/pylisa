...
/**
 * A Python greater function call (e1 > e2).
 * 
 * @author Nicolò Barbato
 */

public class PyGreater extends BinaryNativeCall {

	/**
	 * Builds a Python greater expression at a given location in the program.
	 * 
	...
	public PyGreater(CFG cfg, String sourceFile, int line, int col, Expression left, Expression right) {
