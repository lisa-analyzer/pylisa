...
public class RelaxedRightToLeftEvaluation implements EvaluationOrder {

        /**
         * The singleton instance of this class.
         */
        public static final RelaxedRightToLeftEvaluation INSTANCE = new RelaxedRightToLeftEvaluation();

        private RelaxedRightToLeftEvaluation() {
        }
