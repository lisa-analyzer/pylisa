...
/**
 * Python's power ({@code a ** b}). It evaluates {@code a} and {@code b},
 * then dispatches to {@code type(a).__pow__(a, b)}, falling back to
 * {@code type(b).__rpow__(b, a)} if needed (this codebase has no notion of
 * subclassing between library-defined numeric types, so the "proper
