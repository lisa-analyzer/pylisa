...
/**
 * A Python numerical equals function call (e1 == e2).
 * 
 * @author Nicolò Barbato
 */

public class PyEquals extends BinaryNativeCall{

	/**
	 * Builds a Python equals expression at a given location in the program.
	 * 
	...
	public PyEquals(CFG cfg, CodeLocation loc, Expression left, Expression right) {
