...
/**
 * Native implementation of {@code str.__len__(self)}.
 */
public class StringLen extends UnaryExpression implements PluggableStatement {
	...
	public static StringLen build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new StringLen(cfg, location, "__len__", exprs[0]);
	}
