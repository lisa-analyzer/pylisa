...
public class Delete extends VariadicExpression implements PluggableStatement {
	...
	public Delete(
			...
			Expression[] params) {
		super(cfg, location, "fastapi.delete", params, new HashMap<>() {
			{
				put("path", 1);
	...
	public static Delete build(
			...
			CodeLocation location,
			Expression[] exprs) {
		return new Delete(cfg, location, exprs);
	}
