...
/**
 * Native implementation of {@code <type>.__lt__(self, other)}, shared by every
 * native type registered against it (int, float, str, ...).
 */
public class Lt extends BinaryExpression implements PluggableStatement {
	...
	public static Lt build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new Lt(cfg, location, "__lt__", exprs[0], exprs[1]);
	}
