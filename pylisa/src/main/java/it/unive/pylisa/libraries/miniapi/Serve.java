...
public class Serve extends BinaryExpression implements PluggableStatement {
    ...
    public Serve(CFG cfg, CodeLocation location, Expression statusCode, Expression detail) {
    ...
    public static Serve build(CFG cfg, CodeLocation location, Expression[] exprs) {
        if (exprs.length != 2) {
