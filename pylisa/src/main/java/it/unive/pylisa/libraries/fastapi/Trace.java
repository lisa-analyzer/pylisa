...
public class Trace extends VariadicExpression implements PluggableStatement {
	...
	public Trace(
			...
			Expression[] params) {
		super(cfg, location, "fastapi.trace", params, new HashMap<>() {
			{
				put("path", 1);
	...
	public static Trace build(
			...
			CodeLocation location,
			Expression[] exprs) {
		return new Trace(cfg, location, exprs);
	}
