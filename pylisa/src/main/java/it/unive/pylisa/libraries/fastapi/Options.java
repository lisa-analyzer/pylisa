...
public class Options extends VariadicExpression implements PluggableStatement {
	...
	public Options(
			...
			Expression[] params) {
		super(cfg, location, "fastapi.options", params, new HashMap<>() {
			{
				put("path", 1);
	...
	public static Options build(
			...
			CodeLocation location,
			Expression[] exprs) {
		return new Options(cfg, location, exprs);
	}
