...
public class Put extends VariadicExpression implements PluggableStatement {
	...
	public Put(
			...
			Expression[] params) {
		super(cfg, location, "fastapi.put", params, new HashMap<>() {
			{
				put("path", 1);
	...
	public static Put build(
			...
			CodeLocation location,
			Expression[] exprs) {
		return new Put(cfg, location, exprs);
	}
