 ...
 */
public class FloatMod extends BinaryExpression implements PluggableStatement {
	...
	public static FloatMod build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new FloatMod(cfg, location, "__mod__", exprs[0], exprs[1]);
	}
