 ...
 */
public class FloatPow extends BinaryExpression implements PluggableStatement {
	...
	public static FloatPow build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new FloatPow(cfg, location, "__pow__", exprs[0], exprs[1]);
	}
