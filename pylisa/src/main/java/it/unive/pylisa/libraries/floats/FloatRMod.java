...
/**
 * Native implementation of {@code float.__rmod__(self, other)}, i.e. the
...
public class FloatRMod extends BinaryExpression implements PluggableStatement {
	...
	public static FloatRMod build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new FloatRMod(cfg, location, "__rmod__", exprs[0], exprs[1]);
	}
