 ...
 */
public class FloatTrueDiv extends BinaryExpression implements PluggableStatement {

	protected Statement st;

	protected FloatTrueDiv(
			CFG cfg,
	...
	public static FloatTrueDiv build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new FloatTrueDiv(cfg, location, "__truediv__", exprs[0], exprs[1]);
	}
