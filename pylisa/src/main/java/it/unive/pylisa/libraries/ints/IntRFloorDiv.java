...
/**
 * Native implementation of {@code int.__rfloordiv__(self, other)}, i.e. the
 ...
 */
public class IntRFloorDiv extends BinaryExpression implements PluggableStatement {

	protected Statement st;

	protected IntRFloorDiv(
			CFG cfg,
	...
	public static IntRFloorDiv build(
			CFG cfg,
			CodeLocation location,
			Expression[] exprs) {
		return new IntRFloorDiv(cfg, location, "__rfloordiv__", exprs[0], exprs[1]);
	}
