...
public class RosTopic
        implements DataflowElement<
                    PossibleForwardDataflowDomain<RosTopic>, // dataflow domain that we want
                    RosTopic
        > {
    // instances of this class will go inside a Collection (override equals and hashCode function are necessary)
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(id, rosTopic.id)) return false;
    ...
    @Override
    public Collection<RosTopic> gen(Identifier identifier, ValueExpression valueExpression, ProgramPoint programPoint, PossibleForwardDataflowDomain<RosTopic> rosTopicPossibleForwardDataflowDomain) throws SemanticException {
    ...
    @Override
    public Collection<RosTopic> gen(ValueExpression valueExpression, ProgramPoint programPoint, PossibleForwardDataflowDomain<RosTopic> rosTopicPossibleForwardDataflowDomain) throws SemanticException {
        ...
        if (programPoint instanceof OpenCall) {
            if (Objects.equals(((OpenCall) programPoint).getTargetName(), "create_subscription")) {
                ...
                return Collections.singleton(new RosTopic(null, null, ((OpenCall) programPoint).getSubExpressions()[2].toString(), ((OpenCall) programPoint).getSubExpressions()[1].toString()));
    ...
    @Override
    public Collection<RosTopic> kill(Identifier identifier, ValueExpression valueExpression, ProgramPoint programPoint, PossibleForwardDataflowDomain<RosTopic> rosTopicPossibleForwardDataflowDomain) throws SemanticException {
    ...
    @Override
    public Collection<RosTopic> kill(ValueExpression valueExpression, ProgramPoint programPoint, PossibleForwardDataflowDomain<RosTopic> rosTopicPossibleForwardDataflowDomain) throws SemanticException {
        //System.out.println("KILL from evaluation (non assigning expression)");
        //System.out.println("value exp. -> " + valueExpression);
        //System.out.println("identifier -> " + identifier);
        //System.out.println("programpoint -> " + programPoint);
        return new HashSet<RosTopic>();
