...
public class ModuleUnit extends CompilationUnit {
    ...
    public ModuleUnit(CodeLocation location, Program program, String name) {
        this(location, program, name, true);
    }

    protected ModuleUnit(CodeLocation location, Program program, String name, boolean sealed) {
