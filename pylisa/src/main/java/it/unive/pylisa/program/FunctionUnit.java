...
public class FunctionUnit extends CompilationUnit {
    ...
    public FunctionUnit(CodeLocation location, Program program, String name, CodeMember function) {
        this(location, program, name, true);
        this.function = function;
    }

    protected FunctionUnit(CodeLocation location, Program program, String name, boolean sealed) {
        super(location, program, name, sealed);
    }

    @Override
    public boolean addAncestor(it.unive.lisa.program.CompilationUnit unit) {
        return false;
    }
    ...
    @Override
    public boolean isInstanceOf(it.unive.lisa.program.CompilationUnit unit) {
        return this == unit;
    }
