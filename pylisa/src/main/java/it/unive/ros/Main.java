...
public class Main {
    ...
    public static ROSApplication ROS2OSMCartrographer() throws ROSNodeBuildException, ROSApplicationBuildException {
        return new RosApplicationBuilder()
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/route_network/src/route_network/nodes/plan_route.py"))
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/route_network/src/route_network/nodes/route_network.py"))
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/route_network/src/route_network/nodes/rviz_goal.py"))
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/route_network/src/route_network/nodes/viz_plan.py"))
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/route_network/src/route_network/nodes/viz_routes.py"))
                // add also nodes in osm_cartography
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/osm_cartography/src/osm_cartography/nodes/viz_osm.py"))
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/osm_cartography/src/osm_cartography/nodes/osm_server.py"))
                //.withNode(new PythonROSNodeBuilder("ros-tests/git-repos/ros2_osm_cartographer/osm_cartography/src/osm_cartography/nodes/osm_client.py"))
    ...
    public static ROSApplication TurtlePong() throws ROSNodeBuildException, ROSApplicationBuildException {
        return new RosApplicationBuilder()
                ...
                // .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/Turtle_pong/src/ping_pong/ping_pong/key_teleop.py")) FAIL
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/Turtle_pong/src/ping_pong/ping_pong/paddles.py"))
    ...
    public static ROSApplication AutoCarROS2() throws ROSNodeBuildException, ROSApplicationBuildException {
        return new RosApplicationBuilder()
                ...
                .withNode(new PythonROSNodeBuilder("ros-tests/git-repos/AutoCarROS2/autocar_nav/nodes/globalplanner.py"))
