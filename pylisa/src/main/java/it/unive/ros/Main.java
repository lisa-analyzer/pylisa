...
public class Main {
	...
	public static void main(
		 ...
		 * .withNode(new
		 * PythonROSNodeBuilder("ros-tests/turtlegoal/tb4_planner.py"))
		 * .withNode(new
		 * PythonROSNodeBuilder("ros-tests/turtlegoal/extended_kalman_filter.py"
		 * )) .withNode(new
		 * PythonROSNodeBuilder("ros-tests/turtlegoal/tb4_undock.py"))
		 */
		// AutoCarROS2
		/*
		 * .withNode(new PythonROSNodeBuilder(
		...
		/*
		 * rosApp = TurtlePong(); rosApp.dumpPermissions(); rosApp.dumpGraph();
		 * rosApp.dumpSecureGraph(); rosApp.dumpInfo();
		 * rosApp.dumpGraphUndAdjMatrix(); rosApp.dumpGraphDirAdjMatrix();
		 */
	}
}