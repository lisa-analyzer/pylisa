...
public class Network<Container extends NetworkEntityContainer,
		Entity extends NetworkEntity,
		Channel extends NetworkChannel> {
	...
	public Container getNetworkEntityContainer(
			String id) {
	...
	public List<Entity> getChannelNetworkEntities(
			String channelID) {
