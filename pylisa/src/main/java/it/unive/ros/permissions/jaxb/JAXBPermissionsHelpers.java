...
public class JAXBPermissionsHelpers {
    ...
    public static PermissionsNode load(String fileName) throws JAXBException, FileNotFoundException {
        ...
        JAXBElement<PermissionsNode> permissions = (JAXBElement<PermissionsNode> ) jaxbUnmarshaller.unmarshal(new FileInputStream(fileName));
    ...
    public static void store(PermissionsNode permissions, String fileName) throws JAXBException, IOException {
        ...
        jaxbMarshaller.setProperty(Marshaller.JAXB_NO_NAMESPACE_SCHEMA_LOCATION, "http://www.omg.org/spec/DDS-SECURITY/20170901/omg_shared_ca_permissions.xsd");
